...
public:
  ...
  int JeuOrdi(int &bestMove);                                                   // contenant les instructions permettant d'évaluer les coups de l'ordinateur
  int JeuHumain(int &bestMove);                                                // contenant les instructions permettant d'évaluer les coups de l'humain.
