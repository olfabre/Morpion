...
bool
    ...
    /* *********************************************************** */
    int
    TicTacToe::JeuOrdi(int &bestMove)
{
  /* Elle affecte bestMove le meilleur coup de l’ordinateur et renvoie la valeur de
  l’etat du jeu correspondant à ce coup. Attention la methode ne réalise pas le coup.
  La réalisation effective est faite en dehors de celle-ci.*/
